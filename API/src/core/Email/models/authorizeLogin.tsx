...
const AuthorizeLoginEmail = (token: string) => (
  <Html>
    <Head />
    <Preview>Faça o login através do link.</Preview>
    <Body style={main}>
      <Container style={container}>
        <Section style={box}>
          ...
          />
          <Hr style={hr} />
          <Text style={title}>Autorize o login através do link abaixo.</Text>
          <Text style={paragraph}>
            Caso não tenha sido você que solicitou o acesso pode ignorar esse
            email, e lembre-se de nunca compartilhar esse link com ninguém.
          </Text>
          <Text style={paragraph}>
            Para autorizar o login basta clicar no link abaixo:
          </Text>
          <Button
            style={button}
...
export default AuthorizeLoginEmail;
