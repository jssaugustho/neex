...
export const OtherContext = createContext<OtherContextProps | null>(null);
...
export const OtherProvider = ({ children }: { children: React.ReactNode }) => {
...
export function useOther() {
  ...
  return context as OtherContextProps;
}
