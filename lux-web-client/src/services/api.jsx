...
function initApi(signOut, storage) {
  ...
  api.interceptors.request.use(async (config) => {
    if (storage.sessionId) config.headers["Session"] = storage.sessionId || "";
    ...
    config.headers["Accept-Language"] =
      storage.locale || navigator.language || navigator.userLanguage;

    config.headers["X-Timezone"] =
      storage.timeZone || Intl.DateTimeFormat().resolvedOptions().timeZone;
